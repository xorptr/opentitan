...
typedef struct mldsa_44_public_key {
  uint8_t key[MLDSA44_PUBLIC_KEY_BYTES] OT_WORD_ALIGNED;
} mldsa_44_public_key_t;

typedef struct mldsa_44_signature {
  uint8_t signature[MLDSA44_SIGNATURE_BYTES] OT_WORD_ALIGNED;
} mldsa_44_signature_t;

typedef struct mldsa_87_public_key {
  uint8_t key[MLDSA87_PUBLIC_KEY_BYTES] OT_WORD_ALIGNED;
} mldsa_87_public_key_t;

typedef struct mldsa_87_signature {
  uint8_t signature[MLDSA87_SIGNATURE_BYTES] OT_WORD_ALIGNED;
} mldsa_87_signature_t;
